...
if (document.querySelectorAll('#d-activity').length) {
  ...
  var months=document.getElementById("monthss").value;
var month_array = months.split(",");
var chat_month=document.getElementById("chat_month").value;
var month_chat_array = chat_month.split(",");
console.log(month_chat_array);
var xValues = month_array;
var yValues = month_chat_array;
...
var days_week=document.getElementById("days_week").value;
var chat_week=document.getElementById("chat_week").value;
var chat_array = chat_week.split(",");
var days_array = days_week.split(",");
console.log(chat_array);
console.log(days_array);
var xValues = days_array;
var yValues = chat_array;
var barColors = ["#1ABB9C ","#30ab93 ","#276c5e","#194069","#31557b","#779abf","#072646b3"];
